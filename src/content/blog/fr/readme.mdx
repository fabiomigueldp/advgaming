...
tag:
  - Docs
title: Démarrage 🚀
description: Adventury Network utilise Astro, un framework moderne et performant, avec StarFunnel pour créer des landing pages et sites institutionnels d'excellente qualité.
intro: Cloner, Configurer, Déployer
style:
  template: split
  hero_template: image
  container: md
