...
tag:
  ...
  - Docs
title: Contact Form
description: Adventury Network uses Astro and StarFunnel to create contact forms integrated with MailGun, Postmark or Slack.
intro: Professional contact forms developed with Astro and StarFunnel
style:
  template: split
  hero_template: image
  container: md
