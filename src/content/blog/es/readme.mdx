...
tag:
  - Docs
title: Comenzando 🚀
description: Adventury Network utiliza Astro, un framework moderno y de alto rendimiento, junto con StarFunnel para crear landing pages y sitios institucionales de excelente calidad.
intro: Clonar, Configurar, Desplegar
style:
  template: split
  hero_template: image
  container: md
